...
# NOTE: No need to do such detailed transform. Maybe somebody doesn't use pytorch.
...
class lidar_trans(object):
    ...
    def top_projection(self, points):
        ...
        data_norm = (data_grid - data_grid.min()) / (data_grid.max() - data_grid.min())
    ...
    def sph_projection(self, points):
        ...
        sph_norm = (data_grid - data_grid.min()) / (data_grid.max() - data_grid.min())
